    ...
    <PhoneMockup>
      <div className="flex flex-col min-h-full bg-background">
        ...
        <div className="flex-1 px-[20px] pt-8 pb-8">
          <h1 className="text-xl font-bold text-center text-foreground mb-8">ログイン</h1>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-2">
                パスワードを忘れた方は <button onClick={() => navigate("/forgot-password")} className="text-primary font-medium">こちら</button>
              </p>
            </div>

            {/* Submit */}
            <Button className="w-full h-14 rounded-[8px] text-base font-bold bg-primary text-primary-foreground hover:opacity-90 mt-2">
              ログイン
            </Button>
