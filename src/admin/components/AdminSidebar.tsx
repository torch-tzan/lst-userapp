...
const AdminSidebar = ({ groups, dashboardPath, logoText = "ADMIN" }: AdminSidebarProps) => {
  ...
  return (
    <aside className="flex h-screen w-60 flex-shrink-0 flex-col overflow-hidden bg-slate-900 text-slate-100">
      ...
      >
        <span className="inline-flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-blue-500">
          <span className="text-base font-bold text-white">L</span>
        </span>
        <span className="truncate text-base font-bold tracking-wide text-white">{logoText}</span>
      </button>
