...
const LstBookingDetailAdmin = () => {
    ...
    return (
      <AdminLayout role="lst">
        <AdminPageHeader
          ...
          breadcrumbs={[
            { label: "LST HQ" },
            { label: "予約管理", to: "/admin/lst/bookings" },
            { label: id ?? "—" },
          ]}
        />
        <div className={cardCls}>
          ...
          <Button className="mt-4" variant="outline" onClick={() => navigate("/admin/lst/bookings")}>
            予約一覧へ戻る
          </Button>
        </div>
      </AdminLayout>
  ...
  const affId = getBookingAffiliateId(booking);
  ...
  return (
    <AdminLayout role="lst">
      ...
      <BookingCancelDialog
        ...
        booking={booking}
        onCancelled={() => navigate("/admin/lst/bookings")}
      />
    </AdminLayout>
  );
};

export default LstBookingDetailAdmin;
